...
export var Class614 = function () {
    ...
    a.prototype.member6811 = function (i, b, h, g) {
        ...
        if (this.member6807() !== -1) {
            var d = b.member2970.member3227(Class131.member1214.member1204, this.member6807());
            if (d === member47) {
                return;
            }
            j = d.getName();
            var e = this.member7044();
            if ((d.member7079() === 1 || e !== 1) && e !== -1) {
        ...
        Class302.member3604(j, h, g, c, this.member6752(), this.member6754(), this.member7592(), this.member7594(), this.member7590(), this.member7598(), this.member600(), this.member7596() ? 255 : undefined, k, undefined);
    };
    return a;
}();